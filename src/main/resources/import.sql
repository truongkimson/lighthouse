INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'folkoch@iss.edu.sg', 'Folk', 'Och', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'bacalhau@iss.edu.sg', 'Furia', 'Bacalhau', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'fredweasley@iss.edu.sg', 'Fred', 'Weasley', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'francefranken@iss.edu.sg', 'France', 'Frankenversand', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'godoscocina@iss.edu.sg', 'Godos ', 'Cocina', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'hanaricarnes@iss.edu.sg', 'Hanari', 'Carnes', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'hillarionlanchone@iss.edu.sg', 'Hilarion', 'Lanchonetes', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'handelernst@iss.edu.sg', 'Ernst', 'Handel', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'wartianwellington@iss.edu.sg', 'Wartian', 'Wellington', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'crackerbox@iss.edu.sg', 'Cracker', 'Box', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'ntt@iss.edu.sg', 'Tri Tin', 'Nguyen ', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'cwt@iss.edu.sg', 'Cher Wah', 'Tan', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'esthert@iss.edu.sg', 'Esther', 'Tan', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'suriyap@iss.edu.sg', 'Suriya', 'Priya', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'ykc@iss.edu.sg', 'Yuen Kwan', 'Chia', 'p@ssw0rd');
...
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('ADM', 'ROLE_ADM', 'admin2@iss.edu.sg', 'Zhengguang', 'Han', 'p@ssw0rd');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('ADM', 'ROLE_ADM', 'admin3@iss.edu.sg', 'Shirley', 'Chow', 'p@ssw0rd');
