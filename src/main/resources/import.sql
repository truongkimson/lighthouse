INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'folkoch@iss.edu.sg', 'Folk', 'Och', '$2y$10$CCQj0n5BPiNsrN7f9CXBH.PQPcNaLUOLXecIGcQsStXee2SoNBK1y');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'bacalhau@iss.edu.sg', 'Furia', 'Bacalhau', '$2y$10$TkMPO9sDi4VtS0d9secEVeaAe.9RKwMa.IoAdp5jqTQY5s7K/kgnW');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'fredweasley@iss.edu.sg', 'Fred', 'Weasley', '$2y$10$yS42BAEUe1GS3GUMOq1ym.RjaaC4EKR8DN.76fZvrnPQpiXc8C/Pa');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'francefranken@iss.edu.sg', 'France', 'Frankenversand', '$2y$10$62rGQxNjHnQN87nUmtKX4uSpDyaPyF3uiITTTF.nOQeW7e8PtJt1C');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'godoscocina@iss.edu.sg', 'Godos ', 'Cocina', '$2y$10$hRqkrNdk77JaXJ3wtHyfcOmeN74NlMxF12uHcsXc/euHFqwPFLdOC');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'hanaricarnes@iss.edu.sg', 'Hanari', 'Carnes', '$2y$10$VAf8gWwsi50sxu3G1dcDSeJkJ//9EIt7851qySvsFqIhAVHSChhgS');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'hillarionlanchone@iss.edu.sg', 'Hilarion', 'Lanchonetes', '$2y$10$fUbY0sM4JpGVFKS3idny4.iUiIXOEqM0B.M9eBkac8pBGD/Uk3ij6');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'handelernst@iss.edu.sg', 'Ernst', 'Handel', '$2y$10$OJ3yzI08EGeWITa5n6MGF.SUZaT8aQHfJZmH5c5MMYaUES.6uIJyW');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'wartianwellington@iss.edu.sg', 'Wartian', 'Wellington', '$2y$10$pvfpwnO6LYT/bKPb7UW/ue/IRDAKJTQO71ytxlCuBgY3rEYHHUZiq');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('STU', 'ROLE_STU', 'crackerbox@iss.edu.sg', 'Cracker', 'Box', '$2y$10$U.C9l6ggDR8xVBo3Qdugr./VsvMDFH1bBjCP6.rNltleTvg8BD0m2');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'ntt@iss.edu.sg', 'Tri Tin', 'Nguyen ', '$2y$10$dodbXgY6jucMTXRFNTx/tuIqn52g06j0xTIWYfqP77dVOvZAsOdZ2');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'cwt@iss.edu.sg', 'Cher Wah', 'Tan', '$2y$10$kSbMajPx8Hys23f1ZLckl.2mzSaA3/0RxZcotfJO0ronzmPJNwPJK');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'esthert@iss.edu.sg', 'Esther', 'Tan', '$2y$10$1eFcVUaDUrkBxs6oZiNILubQXijT9QdGP1ylIyEvy8CBdVXRv2Cw2');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'suriyap@iss.edu.sg', 'Suriya', 'Priya', '$2y$10$mSGaPd8KgdZXCXEP69gC.O7KFuTwJ5J4Kjh4kA4LmDnmGh6IOr0CS');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('LEC', 'ROLE_LEC', 'ykc@iss.edu.sg', 'Yuen Kwan', 'Chia', '$2y$10$YEAOhCgJxOItY6cEShtgheJsSTS6kn1MOgnr0R3/BSRBlhzAEUIqi');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('ADM', 'ROLE_ADM', 'admin1@iss.edu.sg', 'Kim', 'Truong', '$2y$10$iiGl.aXXwJENAPmyPgeeVORjyGkwCnXlR1eij.A10h3K6FCjImJQ6');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('ADM', 'ROLE_ADM', 'admin2@iss.edu.sg', 'Zhengguang', 'Han', '$2y$10$0gk7xfETdsOimo0aJxd/tutTVR7hjDomNzC.0YduUr..VOAL0aARa');
INSERT INTO lighthouse.user (user_type, role, email, first_name, last_name, password) VALUES ('ADM', 'ROLE_ADM', 'admin3@iss.edu.sg', 'Shirley', 'Chow', '$2y$10$A8Ku6JZOcHYxnk5drUK/7OxmxmQDwivamqjj3iP3zggnsWfVMOari');
...
INSERT INTO lighthouse.course (course_des, course_name, credits, duration, enroll_by, exam_date, max_cap, start_date, lecturer_id) VALUES ('Planning, scheduling, resource allocation, execution, tracking and delivery of software projects.', 'Digital Product Management', 4, 8, '2021-08-01', '2021-08-29', 30, '2021-08-05', 14);
INSERT INTO lighthouse.course (course_des, course_name, credits, duration, enroll_by, exam_date, max_cap, start_date, lecturer_id) VALUES ('Java Programming - Java Object Persistence - Web-based J2EE Applications - Wireless Technology - J2EE Project', 'Web Application Development', 6, 17, '2021-08-01', '2021-08-30', 60, '2021-08-04', 12);
